  ...
  private
    ...
    def calculate_raised_amount(rule)
      ...
      if !@rule.tags.nil?
        ...
        for o in @orders
          if (o.cancelled_at.nil? && @rule.permanent == true && @rule.first_created < o.updated_at ) || (o.cancelled_at.nil? && o.updated_at > @rule.starting_date && o.updated_at < @rule.ending_date)
