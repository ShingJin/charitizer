  ...
  private
    ...
    def calculate_raised_amount(rule)
      ...
      if !@rule.tags.nil?
        ...
        for o in @orders
          if (o.cancelled_at.nil? && @rule.permanent == true && @rule.first_created < o.updated_at.to_datetime ) || (o.cancelled_at.nil? && o.updated_at.to_datetime > @rule.starting_date && o.updated_at.to_datetime < @rule.ending_date)
